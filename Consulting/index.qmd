...
- **Assumption Checking**
  - **Verify Model Assumptions Before Regression**
    - **Normality** of residuals
    - **Homoscedasticity** (constant variance)
    - **Independence** of observations

- **Correlation Analysis**
  - Use **Pearson's or Spearman's correlation** to explore relationships between variables
...
$$ \text{Rating}_{ijk} = \beta_0 + \beta_1 \text{GraphType}_i + \beta_2 \text{UncertaintyType}_j + \beta_3 \text{NumeracyScore}_k + \beta_4 \text{PersonalityTraits}_k + \varepsilon_{ijk} 
$$

**Response Variable:** Visualization ratings

  - **Include Variables:**
    - **Graph Type** (line vs. bar)
    - **Uncertainty Type** (deterministic, symmetric, asymmetric, exaggerated)
    - **Numeracy Scores**
    - **Personality Traits**
